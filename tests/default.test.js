...
describe("isPalindrome with default settings", () => {
  ...
  test('"race car" is a palindrome', () => expect(isPalindrome("race car")).toBeTruthy())

  test('"not a isPalindrome" is not a palindrome', () => expect(isPalindrome("not a isPalindrome")).toBeFalsy())

  test('"A man, a plan, a canal. Panama" is a palindrome', () => expect(isPalindrome("A man, a plan, a canal. Panama")).toBeTruthy())

  test('"never odd or even" is a palindrome', () => expect(isPalindrome("never odd or even")).toBeTruthy())

  test('"never odd or even" is a palindrome', () => expect(isPalindrome("never odd or even")).toBeTruthy())

  test('"nope" is not a palindrome', () => expect(isPalindrome("nope")).toBeFalsy())

  test('"almostomla" is not a palindrome', () => expect(isPalindrome("almostomla")).toBeFalsy())

  test('"My age is 0, 0 si ega ym." is not a palindrome', () => expect(isPalindrome("My age is 0, 0 si ega ym.")).toBeTruthy())

  test('"1 eye for of 1 eye." is not a palindrome', () => expect(isPalindrome("1 eye for of 1 eye.")).toBeFalsy())

  test('"0_0 (: /-\ :) 0–0" is not a palindrome', () => expect(isPalindrome("0_0 (: /-\ :) 0–0")).toBeTruthy())

  test('"________bob" is not a palindrome', () => expect(isPalindrome("________bob")).toBeTruthy())

  test('"b________ob" is not a palindrome', () => expect(isPalindrome("b________ob")).toBeTruthy())
